...
def main(config_path):
    ...
    model.compile(loss="sparse",optimizer=OPTIMIZER,metrics=METRICS)
    ...
    # model.summary()
    logging.info(f"bin_scratch_model model summary: \n{_log_model_summary(model)}")
    ...
    logging.info(f"bin_scratch_model model is saved at {model_dir_path}")
